...
namespace OpenTK
{
    ...
    public static class Functions
    {
        ...
        public static long NextPowerOfTwo(long n)
        {
            ...
            return (long)System.Math.Pow(2, System.Math.Ceiling(MathHelper.Log((double)n, 2)));
        }
        ...
        {
            if (n < 0) throw new ArgumentOutOfRangeException("n", "Must be positive.");
            return (int)System.Math.Pow(2, System.Math.Ceiling(MathHelper.Log((double)n, 2)));
        }
        ...
        {
            if (n < 0) throw new ArgumentOutOfRangeException("n", "Must be positive.");
            return (float)System.Math.Pow(2, System.Math.Ceiling(MathHelper.Log((double)n, 2)));
        }
        ...
        {
            if (n < 0) throw new ArgumentOutOfRangeException("n", "Must be positive.");
            return System.Math.Pow(2, System.Math.Ceiling(MathHelper.Log((double)n, 2)));
        }
