...
namespace OpenTK
{
    ...
    public static class MathHelper
    {
        ...
        // NOTE: Added to support the missing Log(d, d)
        public static double Log(double d, double newBase)
        {
            return System.Math.Log(d) / System.Math.Log(newBase);
        }
        ...
        public static long NextPowerOfTwo(long n)
        {
            ...
            return (long)System.Math.Pow(2, System.Math.Ceiling(Log((double)n, 2)));
        }
        ...
        {
            if (n < 0) throw new ArgumentOutOfRangeException("n", "Must be positive.");
            return (int)System.Math.Pow(2, System.Math.Ceiling(Log((double)n, 2)));
        }
        ...
        {
            if (n < 0) throw new ArgumentOutOfRangeException("n", "Must be positive.");
            return (float)System.Math.Pow(2, System.Math.Ceiling(Log((double)n, 2)));
        }
        ...
        {
            if (n < 0) throw new ArgumentOutOfRangeException("n", "Must be positive.");
            return System.Math.Pow(2, System.Math.Ceiling(Log((double)n, 2)));
        }
